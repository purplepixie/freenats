-- FreeNATS freenats-1.30.8a Schema
...
CREATE TABLE `fnview` (
  ...
  `vstyle` varchar(32) NOT NULL,
  `vpublic` tinyint(1) NOT NULL DEFAULT '0',
  `vclick` varchar(32) NOT NULL,
...
-- Dump completed on 2024-05-08 16:04:54
