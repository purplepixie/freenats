...
function ViewItemTxt($type, $option)
{
	...
	switch ($type) {
		...
		case "testgraph":
			...
			$sl = strpos($tid, "/");
			if ($sl === false)
				return "Test Graph </b>for<b> " . GetTestDesc($tid) . " (default)"; // will break on non-local sets, refine logic here
