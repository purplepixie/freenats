<?php
// Front Page Items
$lang['homepage']="FreeNATS Homepage";
$lang['welcome']="Welcome to FreeNATS";
$lang['iphone']="iPhone Interface";

$lang['freenats.news']="FreeNATS Latest News";

// Front Page Messages
$lang['msg.logout']="You Are Logged Out";
$lang['msg.session']="Invalid or Expired Session";
$lang['msg.loginfailed']="Login Failed";

// Login Box
$lang['auth']="Please Authenticate";
$lang['username']="Username";
$lang['password']="Password";
$lang['language']="Language";
$lang['login']="Login to the FreeNATS Interface";

// HTTP-AUTH Messages
$lang['httpa.logout']="HTTP AUTH Logout";
$lang['httpa.logout.desc']="To logout from an HTTP-AUTH session you must close the browser or delete your credentials.";
...
$lang['nodes']="Nodes";
$lang['groups']="Groups";
$lang['views.reports']="Views &amp; Reports";
$lang['user.options']="User Options";
$lang['system.settings']="System Settings";
$lang['check.updates']="Check for Updates";

// Alert Pane
$lang['nats.alerts']="NATS Alerts";

// UI Errors
$lang['access.error']="Insufficient Access";
$lang['access.error.detail']="Sorry but your user has insufficient access to perform this task";

// Generalised UI
$lang['click.continue']="Please click here to continue";
$lang['node.default']="Node Default";
$lang['group.default']="Group Default";
$lang['description']="Description";

// Main Screen
$lang['overview.title']="Monitoring Configuration";
$lang['overview.subtitle']="FreeNATS Overview";
$lang['checking.updates']="Checking for Updates";
$lang['update.desc']="You can also check for updates on the <a href=http://www.purplepixie.org/freenats>website</a>. It is recommended you check regularly.<br>You are currently running version";
...
$lang['testrun.manual.close.detail']="Are you sure you want to do this? Only close sessions that you're sure aren't still running in the background.<br>This <b>does not</b> kill processes - just marks the test session as complete.";
...
$lang['status.disclaim']="Please note this merely displays FreeNATS software status - not<br>the status of the underlying Virtual Machine (if applicable).<br><br> You should monitor disk space and performance for the VM via<br>the relevant system (such as the rPath interface).<br><br>";
...
$lang['test.evals.simple']="Custom evaluators will not be parsed as <i>Simple Evaluation</i> is checked (above)";
...
$lang['sec.firstrun.text']="The firstrun.php script in your web directory has not been renamed. This could be used to damage FreeNATS.<br />Please rename to firstrun-.php.";
